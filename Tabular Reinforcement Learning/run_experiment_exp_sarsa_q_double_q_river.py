...
plot_heatmap_riverswim((agent.q_table_1 + agent.q_table_2) / 2, title='RiverSwim Q-values Double Q-learning')

print()
""" 
np.save('Expected_Sarsa_data_river.npy', final_rewards)
...
np.save('Expected_Sarsa_average_river.npy', final_rewards)
np.save('Expected_Sarsa_std_river.npy', final_rewards_std)
plt.xlabel('Epochs')
...
plt.show()
plt.savefig('Expected_Sarsa_Average_river') """